<template>
  <div class="w-full h-full flex">
    ...
    <div class="flex flex-col w-2/5 px-20">
      <h1 class="text-titlegrey text-4xl mt-32 mb-10 self-start">Sûr de vouloir modifier ton super mot de passe ?</h1>
      <form class="flex flex-col" @submit.prevent="changePassword($store.state.isLogged._id)">
  ...
  methods: {
    ...
    modifyPassword(userId) {
      if (this.newPasswordValid) {
        ...
        this.errorMessage = "Doucement ! Erreur détectée ! Vérifie les champs";
      }
    }
  }
}
